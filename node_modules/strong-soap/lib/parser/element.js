...
class Element {
  constructor(nsName, attrs, options) {
    ...
    if (this.constructor.elementName) {
      assert(this.name === this.constructor.elementName, 'Invalid element name: ' + this.name);
    }
  ...
  startElement(stack, nsName, attrs, options) {
    ...
    if (this.constructor.allowedChildren.indexOf(qname.name) === -1 && this.constructor.allowedChildren.indexOf('any') === -1) {
