...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/server.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">strong-soap/src</a> server.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">87.01% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>201/231</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">63.3% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>69/109</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Copyright IBM Corp. 2016,2018. All Rights Reserved.
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (path[path.length - 1] !== '/')
      path += '/';
...
&nbsp;
      ...
      server.addListener('request', function(req, res) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof self.authorizeConnection === 'function') {
<span class="cstat-no" title="statement not covered" >          if (!self.authorizeConnection(req.connection.remoteAddress)) {</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof self.log === 'function') {
<span class="cstat-no" title="statement not covered" >      self.log('info', 'Handling ' + req.method + ' on ' + req.url);</span>
    }
&nbsp;
    if (req.method === 'GET') {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (reqQuery &amp;&amp; reqQuery.toLowerCase() === '?wsdl') {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof self.log === 'function') {
<span class="cstat-no" title="statement not covered" >          self.log('info', 'Wants the WSDL');</span>
        }
      ...
      var chunks = [], gunzip;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (compress &amp;&amp; req.headers['content-encoding'] === 'gzip') {
<span class="cstat-no" title="statement not covered" >        gunzip = new compress.Gunzip();</span>
<span class="cstat-no" title="statement not covered" >        gunzip.init();</span>
      }
      req.on('data', function(chunk) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (gunzip)
<span class="cstat-no" title="statement not covered" >          chunk = gunzip.inflate(chunk, 'binary');</span>
        chunks.push(chunk);
      });
      req.on('end', function() {
        var xml = chunks.join('');
        ...
        var error;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (gunzip) {
<span class="cstat-no" title="statement not covered" >          gunzip.end();</span>
<span class="cstat-no" title="statement not covered" >          gunzip = null;</span>
        }
        try {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof self.log === 'function') {
<span class="cstat-no" title="statement not covered" >            self.log('received', xml);</span>
          }
          self._process(xml, req, function(result, statusCode) {
            ...
            res.end();
            <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof self.log === 'function') {
<span class="cstat-no" title="statement not covered" >              self.log('replied', result);</span>
            }
          });
        }
        catch (err) {
          error = err.stack || <span class="branch-1 cbranch-no" title="branch not covered" >err;</span>
          res.statusCode = 500;
          res.write(error);
          res.end();
          <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof self.log === 'function') {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof self.authenticate === 'function') {
<span class="cstat-no" title="statement not covered" >      if (!obj.Header || !obj.Header.Security) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(g.f('No security header'));</span>
      }
<span class="cstat-no" title="statement not covered" >      if (!self.authenticate(obj.Header.Security)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(g.f('Invalid username or password'));</span>
      }
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof self.log === 'function') {
<span class="cstat-no" title="statement not covered" >      self.log('info', 'Attempting to bind to ' + pathname);</span>
    }
&nbsp;
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof self.log === 'function') {
<span class="cstat-no" title="statement not covered" >            self.log('info', 'Trying ' + portName + ' from path ' + portPathname);</span>
          }
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (portPathname === pathname)
            return port.binding;
&nbsp;
          // The port path is almost always wrong for generated WSDLs
<span class="cstat-no" title="statement not covered" >          if (!firstPort) {</span>
<span class="cstat-no" title="statement not covered" >            firstPort = port;</span>
          }
        }
      }
<span class="cstat-no" title="statement not covered" >      return !firstPort ? void 0 : firstPort.binding;</span>
    })(this);
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!binding) {
<span class="cstat-no" title="statement not covered" >      throw new Error(g.f('Failed to bind to {{WSDL}}'));</span>
    }
&nbsp;
    try {
...
<span class="cstat-no" title="statement not covered" >          self.emit('headers', headers, operationName);</span>
&nbsp;
        self._executeMethod({
...
<span class="branch-0 cbranch-no" title="branch not covered" >          Object.keys(body)[1] </span>: Object.keys(body)[0]);
...
<span class="cstat-no" title="statement not covered" >      debug('Server executeMethod: error: %s ', error.message);</span>
      //fix - should create a fault and call sendError (..) so that this error is not lost and will be sent as Fault in soap envelope
      //to the client?
<span class="cstat-no" title="statement not covered" >      return callback(this._envelope('', includeTimestamp));</span>
    }
&nbsp;
    function handleResult(error, result) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (handled)
<span class="cstat-no" title="statement not covered" >        return;</span>
      handled = true;
&nbsp;
...
&nbsp;
      ...
      var soapNsPrefix = self.wsdl.options.envelopeKey || <span class="branch-1 cbranch-no" title="branch not covered" >'soap';</span>
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (operation.soapVersion === '1.2') {
<span class="cstat-no" title="statement not covered" >        soapNsURI = 'http://www.w3.org/2003/05/soap-envelope';</span>
      }
&nbsp;
...
&nbsp;
  _envelope(env, includeTimestamp) {
    env = env || <span class="branch-1 cbranch-no" title="branch not covered" >XMLHandler.createSOAPEnvelope();</span>
&nbsp;
    if (includeTimestamp) {
