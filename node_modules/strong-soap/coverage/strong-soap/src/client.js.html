...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/client.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">strong-soap/src</a> client.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">92.96% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>185/199</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>184/198</span>
      </div>
    </div>
    <p class="quiet">
...
<span class="cline-any cline-yes">268x</span>
<span class="cline-any cline-yes">268x</span>
<span class="cline-any cline-yes">1987x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  se</span>tSOAPAction(soapAction) {
<span class="cstat-no" title="statement not covered" >    this.SOAPAction = soapAction;</span>
  }
&nbsp;
...
&nbsp;
  _defineOperation(operation, location) {
    ...
    return function(args, callback, options, extraHeaders) {
      if (!args) args = {};
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof args === 'function') {
...
&nbsp;
    ...
    var soapNsPrefix = this.wsdl.options.envelopeKey || <span class="branch-1 cbranch-no" title="branch not covered" >'soap';</span>
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.SOAPAction) {
<span class="cstat-no" title="statement not covered" >      soapAction = this.SOAPAction;</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (operation.soapAction != null) {
      soapAction = operation.soapAction;
    } else {
<span class="cstat-no" title="statement not covered" >      soapAction = ((ns.lastIndexOf("/") !== ns.length - 1) ? ns + "/" : ns) + name;</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      headers[header] = this.httpHeaders[header];</span>
    }
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (self.httpClient.options &amp;&amp; self.httpClient.options.NTLMSecurity) {
<span class="cstat-no" title="statement not covered" >      self.security = self.httpClient.options.NTLMSecurity;</span>
    }
&nbsp;
...
&nbsp;
    ...
    var xmlHandler = this.xmlHandler || <span class="branch-1 cbranch-no" title="branch not covered" >new XMLHandler(this.wsdl.schemas, options);</span>
...
&nbsp;
    for(let uri in schemas) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if(complexTypes) {
...
&nbsp;
    var tryJSONparse = <span class="fstat-no" title="function not covered" >fu</span>nction(body) {
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        return JSON.parse(body);</span>
      }
      catch (err) {
...
<span class="cstat-no" title="statement not covered" >            debug('client response. output not present');</span>
            //  If the response is JSON then return it as-is.
            var json = <span class="cstat-no" title="statement not covered" >_.isObject(body) ? body : tryJSONparse(body);</span>
<span class="cstat-no" title="statement not covered" >            if (json) {</span>
<span class="cstat-no" title="statement not covered" >              return callback(null, response, json);</span>
            }
          }
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (outputBodyDescriptor.elements.length) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (req != null) {
