...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/parser/xmlHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">strong-soap/src/parser</a> xmlHandler.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">87.5% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>455/520</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">77.75% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>318/409</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>443/501</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L899'></a><a href='#L899'>899</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">2007x</span>
<span class="cline-any cline-yes">1310x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Copyright IBM Corp. 2016,2019. All Rights Reserved.
...
class XMLHandler {
  constructor(schemas, options) {
    this.schemas = schemas || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
<span class="cstat-no" title="statement not covered" >      node = xmlBuilder.begin(</span>
...
&nbsp;
    ...
    if (descriptor instanceof AttributeDescriptor) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (descriptor.qname) {
        let mapping = declareNamespace(nsContext, node, descriptor.qname.prefix,
          descriptor.qname.nsURI);
        let prefix = mapping ? mapping.prefix : <span class="branch-1 cbranch-no" title="branch not covered" >descriptor.qname.prefix;</span>
        let attrName = prefix ? prefix + ':' + name : <span class="branch-1 cbranch-no" title="branch not covered" >name;</span>
...
&nbsp;
    if (descriptor instanceof ElementDescriptor) {
      ...
      if (descriptor.form === 'unqualified') {
        ...
        let prefix = mapping ? mapping.prefix : <span class="branch-1 cbranch-no" title="branch not covered" >descriptor.qname.prefix;</span>
        elementName = prefix ? prefix + ':' + name : <span class="branch-1 cbranch-no" title="branch not covered" >name;</span>
        // if namespace is newly declared add the xmlns attribute
        if (newlyDeclared) {
          xmlns = prefix ? 'xmlns:' + prefix : <span class="branch-1 cbranch-no" title="branch not covered" >'xmlns';</span>
        }
      }
&nbsp;
      // add the element to a parent node
        ...
        if (this.options.enforceRestrictions &amp;&amp; descriptor.type) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (schema) {
            ...
            if (type) {
              ...
              <span class="missing-if-branch" title="else path not taken" >E</span>if (restriction) {
...
&nbsp;
      if (xmlns &amp;&amp; descriptor.qname.nsURI) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof element.attribute === 'function') {
...
&nbsp;
      if (isSimple) {
        if (attrs !== null) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof attrs === "object") {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (nameSpaceContextCreated) {
        ...
        if (typeof attrs === 'object') {
          for (let p in attrs) {
            ...
            if (p === this.options.xsiTypeKey) {
              <span class="missing-if-branch" title="else path not taken" >E</span>if (descriptor instanceof ElementDescriptor) {
                if (descriptor.refOriginal) {
                  <span class="missing-if-branch" title="else path not taken" >E</span>if (descriptor.refOriginal.typeDescriptor) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (descriptor == null  || descriptor === undefined || descriptor instanceof TypeDescriptor) {
...
<span class="branch-1 cbranch-no" title="branch not covered" >              schema.simpleTypes[xsiType.name];</span>
...
&nbsp;
  ...
  mapObject(node, nsContext, descriptor, val, attrs) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof val !== 'object' || (val instanceof Date)) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!Array.isArray(val)) {
      ...
      for (let p of names) {
        if (p === this.options.attributesKey)
	      ...
	      if (childDescriptor == null) {
	        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.ignoreUnknownProperties)
<span class="cstat-no" title="statement not covered" >            continue;</span>
          else
            childDescriptor = new ElementDescriptor(
              QName.parse(p), null, 'unqualified', Array.isArray(child));
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (childDescriptor) {
      ...
      for (let p in attrs) {
        ...
        if (p === this.options.xsiTypeKey) {
          ...
          let mapping = declareNamespace(nsContext, node, xsiType.prefix,
            xsiType.nsURI);
          let prefix = mapping ? mapping.prefix : <span class="branch-1 cbranch-no" title="branch not covered" >xsiType.prefix;</span>
          node.attribute('xsi:type', prefix ? prefix + ':' + xsiType.name :
<span class="branch-1 cbranch-no" title="branch not covered" >            xsiType.name)</span>;
          continue;
        }
        let childDescriptor = attributes[p];
        if (childDescriptor == null) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.ignoreUnknownProperties) <span class="cstat-no" title="statement not covered" >continue;</span>
          else {
            childDescriptor =
...
&nbsp;
  static createSOAPEnvelope(prefix, nsURI) {
    prefix = prefix || <span class="branch-1 cbranch-no" title="branch not covered" >'soap';</span>
    var doc = xmlBuilder.create(prefix + ':Envelope',
      {version: '1.0', encoding: 'UTF-8', standalone: true});
    nsURI = nsURI || <span class="branch-1 cbranch-no" title="branch not covered" >'http://schemas.xmlsoap.org/soap/envelope/'</span>
...
&nbsp;
    var envelopeDescriptor = <span class="cstat-no" title="statement not covered" >new ElementDescriptor(</span>
...
&nbsp;
    var headerDescriptor = <span class="cstat-no" title="statement not covered" >new ElementDescriptor(</span>
      new QName(nsURI, 'Header', prefix), null, 'qualified', false);
&nbsp;
    var bodyDescriptor = <span class="cstat-no" title="statement not covered" >new ElementDescriptor(</span>
...
<span class="cstat-no" title="statement not covered" >    if (parameterDescriptor &amp;&amp; parameterDescriptor.faults) {</span>
      ...
      var faultDescriptor = <span class="cstat-no" title="statement not covered" >new ElementDescriptor(</span>
        new QName(nsURI, 'Fault', prefix), null, 'qualified', false);
<span class="cstat-no" title="statement not covered" >      faultDescriptor.addElement(</span>
...
<span class="cstat-no" title="statement not covered" >        new ElementDescriptor(nsURI, 'detail', null, 'qualified', false);</span>
...
<span class="cstat-no" title="statement not covered" >      root = xmlBuilder.begin();</span>
    }
    let current = root;
    let stack = [root];
&nbsp;
...
&nbsp;
  _processText(top, val) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (top.object === null) <span class="cstat-no" title="statement not covered" >return;</span>
    // Top object has no other elements or attributes
    if (top.object === undefined) {
      top.object = val;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (top.object.constructor === Object) {
...
&nbsp;
      ...
      for (let a in attrs) {
        ...
        if (nsContext.getNamespaceURI(qname.prefix) === helper.namespaces.xsi) {
          ...
          if (qname.name == 'nil') {
            // xsi:nil
            <span class="missing-if-branch" title="else path not taken" >E</span>if (attrs[a] === 'true') {
              obj = null;
            }
            continue;
          } else <span class="missing-if-branch" title="else path not taken" >E</span>if (qname.name === 'type') {
            // xsi:type
            isXsiType = true;
            xsiType = attrs[a];
            xsiType = QName.parse(xsiType);
            attrs[a] = xsiType.name;
            <span class="missing-if-branch" title="else path not taken" >E</span>if(xsiType.prefix){
...
&nbsp;
      // SOAP href (#id)
      <span class="missing-if-branch" title="if path not taken" >I</span>if (attrs.href != null) {
...
<span class="cstat-no" title="statement not covered" >        refs[id].hrefs.push({</span>
      ...
      id = attrs.id;
      if (id != null) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (refs[id] === undefined)
...
&nbsp;
    p.onclosetag = function(nsName) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (top.object !== null) {
...
&nbsp;
    p.oncdata = function(text) {
      text = text &amp;&amp; text.trim();
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!text.length)
...
&nbsp;
    // merge obj with href
    var merge = <span class="fstat-no" title="function not covered" >fu</span>nction(href, obj) {
...
&nbsp;
    if (root.Envelope) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (root.Envelope.Body !== undefined &amp;&amp; root.Envelope.Body !== null) {
        if (body.Fault !== undefined &amp;&amp; body.Fault !== null) {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (errorMessage == null) {
...
function getSoap11FaultErrorMessage(faultBody) {
  ...
  if (faultcode) { //soap 1.1 fault
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof faultcode == 'string') {
      errorMessage =  'faultcode: ' + faultcode;
    }
    var faultstring = selectn('faultstring.$value', faultBody) ||
      selectn('faultstring', faultBody);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (faultstring &amp;&amp; (typeof faultstring == 'string')) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (faultactor &amp;&amp; (typeof faultactor == 'string')) {
...
<span class="branch-1 cbranch-no" title="branch not covered" >    selectn('Code', faultBody);</span>
...
<span class="cstat-no" title="statement not covered" >      errorMessage = errorMessage + ' ' + 'Value: ' + JSON.stringify(value);</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (subCode) {
<span class="cstat-no" title="statement not covered" >      errorMessage = errorMessage + ' ' + 'Subcode: ' + JSON.stringify(subCode);</span>
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (reason) {
    ...
    var detail = selectn('Detail.$value', faultBody) ||
      selectn('Detail', faultBody);
    if (detail != null) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof detail == 'string') { //plain text
...
function declareNamespace(nsContext, node, prefix, nsURI) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!mapping) {
<span class="cstat-no" title="statement not covered" >    return false;</span>
  } else if (node) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof node.attribute === 'function') {
...
function parseValue(text, descriptor) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof text !== 'string') <span class="cstat-no" title="statement not covered" >return text;</span>
  var value = text;
