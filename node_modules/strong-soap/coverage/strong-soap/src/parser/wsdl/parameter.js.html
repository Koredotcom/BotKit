...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/parser/wsdl/parameter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">strong-soap/src/parser/wsdl</a> parameter.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        console.error('Unable to resolve message %s for', this.$message, this);</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Unable to resolve message ' + this.$message);</span>
      }
...
&nbsp;
    ...
    if (this.parent.parent.name === 'binding') {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.body) {
        if (this.body.$parts) {
          this.body.parts = {};
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (this.message &amp;&amp; this.message.parts) {
      ...
      if (this.headers) {
        for (let i = 0, n = this.headers.length; i &lt; n; i++) {
          ...
          let message;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (header.$message) {
...
<span class="cstat-no" title="statement not covered" >            message = this.message;</span>
          }
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.name === 'fault') {
        let message = <span class="cstat-no" title="statement not covered" >this.fault.parent.message;</span>
<span class="cstat-no" title="statement not covered" >        if (message) {</span>
<span class="cstat-no" title="statement not covered" >          message.postProcess(definitions);</span>
<span class="cstat-no" title="statement not covered" >          for (let p in message.parts) {</span>
            // The fault message MUST have only one part per WSDL 1.1 spec
<span class="cstat-no" title="statement not covered" >            this.fault.part = message.parts[p];</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
          }
        } else {
<span class="cstat-no" title="statement not covered" >          debug('Message not found: ', this.fault.$message);</span>
        }
      }
    }
  }
