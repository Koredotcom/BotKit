...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/parser/wsdl/binding.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">strong-soap/src/parser/wsdl</a> binding.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  postProcess(definitions) {
    ...
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (portType) {
...
&nbsp;
            ...
            for (var f in operation.faults) {
              <span class="missing-if-branch" title="else path not taken" >E</span>if (operation.faults[f]) {
