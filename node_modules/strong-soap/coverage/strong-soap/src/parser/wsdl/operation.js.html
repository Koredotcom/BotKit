...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/parser/wsdl/operation.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">strong-soap/src/parser/wsdl</a> operation.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">98.63% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>216/219</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.36% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>150/166</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>209/211</span>
      </div>
    </div>
    <p class="quiet">
...
&nbsp;
  postProcess(definitions) {
    try {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this._processed) <span class="cstat-no" title="statement not covered" >return; </span>// Already processed
...
&nbsp;
  static describeHeaders(param, definitions) {
    ...
    param.headers.forEach(function(header) {
      ...
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (part &amp;&amp; part.type) {
<span class="cstat-no" title="statement not covered" >        g.warn('{{WS-I}} violation: ' +</span>
  ...
  describe(definitions) {
    ...
    switch (this.mode) {
      case Style.documentLiteralWrapped:
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.input &amp;&amp; this.input.body) {
          for (let p in this.input.body.parts) {
            let wrapperElement = this.input.body.parts[p].element;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (wrapperElement) {
              input = wrapperElement.describe(definitions);
            }
            break;
          }
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.output &amp;&amp; this.output.body) {
      ...
      case Style.rpcEncoded:
        ...
        if (this.output &amp;&amp; this.output.body) {
          for (let p in this.output.body.parts) {
            ...
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (part.element) {
...
&nbsp;
  static createEnvelopeDescriptor(parameterDescriptor, isOutput, soapVersion, prefix, nsURI) {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (soapVersion === '1.2') {
  ...
  getMode() {
    ...
    if (this.style === 'document' &amp;&amp; use === 'literal') {
      ...
      if (count === 1 &amp;&amp; element.$name === this.$name) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (count === 1) {
          this.mode = Style.documentLiteralWrapped;
        } else {
<span class="cstat-no" title="statement not covered" >          this.mode = Style.documentLiteral;</span>
        }
      } else {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.style === 'rpc' &amp;&amp; use === 'literal') {
