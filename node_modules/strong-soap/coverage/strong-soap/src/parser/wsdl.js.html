...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/parser/wsdl.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">strong-soap/src/parser</a> wsdl.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">85.67% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>251/293</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>251/291</span>
      </div>
    </div>
    <p class="quiet">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">340x</span>
<span class="cline-any cline-yes">6646x</span>
<span class="cline-any cline-yes">3340x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">340x</span>
<span class="cline-any cline-yes">66207x</span>
<span class="cline-any cline-yes">66207x</span>
<span class="cline-any cline-yes">66207x</span>
<span class="cline-any cline-yes">66207x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">66207x</span>
<span class="cline-any cline-yes">65868x</span>
<span class="cline-any cline-yes">65868x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="branch-2 cbranch-no" title="branch not covered" >      typeof this.content === 'object')</span>,
      'WSDL constructor takes either an XML string or definitions object');
    this.uri = uri;
    this._includesWsdl = [];
&nbsp;
    // initialize WSDL cache
    this.WSDL_CACHE = (options || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>.WSDL_CACHE || {};
...
&nbsp;
  _loadAsyncOrSync(syncLoad, callback) {
    ...
    let fromFunc;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof definition === 'string') {
      definition = stripBom(definition);
      fromFunc = this._fromXML;
    }
    else <span class="cstat-no" title="statement not covered" >if (typeof definition === 'object') {</span>
<span class="cstat-no" title="statement not covered" >      fromFunc = this._fromServices;</span>
    }
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (services) {
...
&nbsp;
  _initializeOptions(options) {
    this._originalIgnoredNamespaces = (options || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>.ignoredNamespaces;
    this.options = {};
&nbsp;
    var ignoredNamespaces = options ? options.ignoredNamespaces : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
&nbsp;
    if (ignoredNamespaces &amp;&amp;
      (Array.isArray(ignoredNamespaces.namespaces) ||
      typeof ignoredNamespaces.namespaces === 'string')) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ignoredNamespaces.override) {
        this.options.ignoredNamespaces = ignoredNamespaces.namespaces;
      } else {
<span class="cstat-no" title="statement not covered" >        this.options.ignoredNamespaces =</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.request) {
<span class="cstat-no" title="statement not covered" >      this.options.request = options.request;</span>
    }
&nbsp;
    var ignoreBaseNameSpaces = options ? options.ignoreBaseNameSpaces : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.NTLMSecurity) {
<span class="cstat-no" title="statement not covered" >      this.options.NTLMSecurity = options.NTLMSecurity;</span>
    }
  }
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (wsdl.definitions instanceof Definitions) {
        // Set namespace for included schema that does not have targetNamespace
        if (undefined in wsdl.definitions.schemas) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (include.namespace != null) {
...
<span class="cstat-no" title="statement not covered" >        self.definitions.schemas[include.namespace ||</span>
...
&nbsp;
    for (var ns in schemas) {
      ...
      includes = includes.concat(schema.includes || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>;
    }
&nbsp;
...
&nbsp;
  toXML() {
    return this.xml || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  xm</span>lToObject(xml) {
...
<span class="cstat-no" title="statement not covered" >          debug("WSDL error: %s ", e.message);</span>
<span class="cstat-no" title="statement not covered" >          if (self.options.strict) {</span>
<span class="cstat-no" title="statement not covered" >            throw e;</span>
          } else {
<span class="cstat-no" title="statement not covered" >            stack.push(new Element(nsName, attrs, options));</span>
          }
        }
      } else {
        ...
        if (name === 'definitions') {
          ...
          stack.push(root);
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (name === 'schema') {
...
<span class="cstat-no" title="statement not covered" >          throw new Error(g.f('Unexpected root element of {{WSDL}} or include'));</span>
        }
      }
    };
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  _f</span>romServices(services) {
  }
&nbsp;
  _xmlnsMap() {
    ...
    for (var prefix in xmlns) {
      ...
      if (~ns.indexOf('http://www.w3.org/'))
        continue;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (~ns.indexOf('http://xml.apache.org/'))
...
<span class="cstat-no" title="statement not covered" >          callback(err);</span>
      ...
      httpClient.request(uri, null /* options */,
        function(err, response, definition) {
          if (err) {
            callback(err);
          } else <span class="missing-if-branch" title="else path not taken" >E</span>if (response &amp;&amp; response.statusCode === 200) {
            wsdl = new WSDL(definition, uri, options);
            WSDL_CACHE[uri] = wsdl;
            wsdl.WSDL_CACHE = WSDL_CACHE;
            wsdl.load(callback);
          } else {
<span class="cstat-no" title="statement not covered" >            callback(new Error(g.f('Invalid {{WSDL URL}}: %s\n\n\r Code: %s' +</span>
...
&nbsp;
    if (fromCache = WSDL_CACHE[uri]) {
       ...
       * into the cache, but with no processing performed on it yet.
       */
      <span class="missing-if-branch" title="if path not taken" >I</span>if(fromCache.isLoaded){
...
&nbsp;
    // initialize cache when calling open directly
    var WSDL_CACHE = options.WSDL_CACHE || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    var request_headers = options.wsdl_headers;
    var request_options = options.wsdl_options;
&nbsp;
    debug('wsdl open. request_headers: %j request_options: %j', request_headers, request_options);
...
&nbsp;
<span class="fstat-no" title="function not covered" >  st</span>atic loadSystemSchemas(callback) {
    var xsdDir = <span class="cstat-no" title="statement not covered" >path.join(__dirname, '../../xsds/');</span>
    var done = <span class="cstat-no" title="statement not covered" >false;</span>
<span class="cstat-no" title="statement not covered" >    fs.readdir(xsdDir, <span class="fstat-no" title="function not covered" >fu</span>nction(err, files) {</span>
<span class="cstat-no" title="statement not covered" >      if (err) <span class="cstat-no" title="statement not covered" >return callback(err);</span></span>
      var schemas = <span class="cstat-no" title="statement not covered" >{};</span>
      var count = <span class="cstat-no" title="statement not covered" >files.length;</span>
<span class="cstat-no" title="statement not covered" >      files.forEach(<span class="fstat-no" title="function not covered" >fu</span>nction(f) {</span>
<span class="cstat-no" title="statement not covered" >        WSDL.open(path.join(xsdDir, f), {}, <span class="fstat-no" title="function not covered" >fu</span>nction(err, wsdl) {</span>
...
<span class="cstat-no" title="statement not covered" >          for (var s in wsdl.definitions.schemas) {</span>
<span class="cstat-no" title="statement not covered" >            schemas[s] = wsdl.definitions.schemas[s];</span>
          }
<span class="cstat-no" title="statement not covered" >          if (count === 0) {</span>
<span class="cstat-no" title="statement not covered" >            done = true;</span>
<span class="cstat-no" title="statement not covered" >            callback(null, schemas);</span>
          }
        });
      });
    });
...
module.exports = WSDL;
&nbsp;
function <span class="fstat-no" title="function not covered" >deepMerge(</span>destination, source) {
<span class="cstat-no" title="statement not covered" >  return _.mergeWith(destination || {}, source, <span class="fstat-no" title="function not covered" >fu</span>nction(a, b) {</span>
<span class="cstat-no" title="statement not covered" >    return _.isArray(a) ? a.concat(b) : undefined;</span>
  });
}
&nbsp;</pre></td></tr>
</table></pre>
