...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/parser/xsd/restriction.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">strong-soap/src/parser/xsd</a> restriction.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">91.59% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>98/107</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">24498x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">36x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">24453x</span>
<span class="cline-any cline-yes">24453x</span>
<span class="cline-any cline-yes">24453x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">24498x</span>
...
&nbsp;
  addChild(child) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.parent.elementName === 'simpleContent') {
      //
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.parent.elementName === 'complexContent') {
      //
    }
  }
&nbsp;
  describe(definitions) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.descriptor) <span class="cstat-no" title="statement not covered" >return this.descriptor;</span>
    var descriptor = this.descriptor =
      new XSDElement.TypeDescriptor();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.base) {
<span class="cstat-no" title="statement not covered" >      descriptor.add(this.base.describe(definitions));</span>
    }
...
&nbsp;
  postProcess(defintions) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.$base) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.parent.name === 'complexContent') {
...
&nbsp;
    if (this.fractionDigits !== undefined) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof val === 'number') {
