...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/base.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">strong-soap/src</a> base.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  se</span>tHttpHeader(name, value) {
<span class="cstat-no" title="statement not covered" >    this.httpHeaders[name] = String(value);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.httpHeaders[name] = val + ', ' + value;</span>
    } else {
...
&nbsp;
    var namespaces = this.wsdl.definitions.xmlns || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    for (var prefix in namespaces) {
      if (prefix === '')
        continue;
      var nsURI = namespaces[prefix];
      switch (nsURI) {
<span class="branch-0 cbranch-no" title="branch not covered" >        case "http://xml.apache.org/xml-soap" : </span>// apachesoap
      ...
      if (~nsURI.indexOf('http://www.w3.org/'))
        continue;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (~nsURI.indexOf('http://xml.apache.org/'))
