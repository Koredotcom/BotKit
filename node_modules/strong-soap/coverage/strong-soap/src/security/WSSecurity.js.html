...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/security/WSSecurity.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">strong-soap/src/security</a> WSSecurity.js
    </h1>
    <div class='clearfix'>
...
class WSSecurity extends Security {
  constructor(username, password, options) {
    ...
    if (typeof options === 'string') {
      this._passwordType = options ? options : <span class="branch-1 cbranch-no" title="branch not covered" >'PasswordText';</span>
      options = {};
    } else {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.mustUnderstand != null) {
<span class="cstat-no" title="statement not covered" >      this._mustUnderstand = !!options.mustUnderstand;</span>
    }
  }
&nbsp;
  addSoapHeaders(headerElement) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this._mustUnderstand) {
<span class="cstat-no" title="statement not covered" >      secElement.attribute('soap:mustUnderstand', '1');</span>
    }
&nbsp;
    secElement
...
&nbsp;
    var password;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this._passwordType === 'PasswordText') {
...
<span class="cstat-no" title="statement not covered" >      userNameElement.element('wsse:Password')</span>
        .attribute('Type', 'http://docs.oasis-open.org/wss/2004/01/' +
          'oasis-200401-wss-username-token-profile-1.0#PasswordDigest')
        .text(passwordDigest(nonce, created, this._password));
&nbsp;
<span class="cstat-no" title="statement not covered" >      userNameElement.element('wsse:Nonce')</span>
        .attribute('EncodingType', 'http://docs.oasis-open.org/wss/2004/01/' +
          'oasis-200401-wss-soap-message-security-1.0#Base64Binary')
        .text(nonce);
    }
